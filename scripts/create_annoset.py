...
caffe_root = '/home/guodong/dpln/ssd_caffe/'  # this file should be run from {caffe_root}/examples (otherwise change this line)
...
if __name__ == "__main__":
  ...
  # root_dir = args.root
  root_dir = '/home/guodong/dpln/ssd_caffe/data/VOCdevkit'
